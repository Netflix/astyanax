...
public class CqlKeyspaceImplTest {

	private static Logger LOG = LoggerFactory.getLogger(CqlKeyspaceImplTest.class);
...
//	    private static String TEST_CLUSTER_NAME  = "Test Cluster"; // TODO: change this
//	    private static String TEST_KEYSPACE_NAME = "AstyanaxUnitTests";
	    ...
	    public static void createKeyspace() throws Exception {
	        ...
	        keyspace.createKeyspace(ImmutableMap.<String, Object>builder()
	        	    					.put("replication", ImmutableMap.<String, Object>builder()
