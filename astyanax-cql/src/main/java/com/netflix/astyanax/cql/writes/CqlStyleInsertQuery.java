...
public class CqlStyleInsertQuery extends CqlStyleMutationQuery {
	...
	public CqlStyleInsertQuery(ChainedContext context, List<CqlColumnMutationImpl> mutationList, Long timestamp, Integer ttl, ConsistencyLevel consistencyLevel) {
