 ...
 *
 */
public class NewShardedQueue implements MessageQueue {
    private static final Logger LOG = LoggerFactory.getLogger(NewShardedQueue.class);
    ...
    public static class Builder {
        private NewShardedQueue queue = new NewShardedQueue();
        ...
        public NewShardedQueue build() throws MessageQueueException {
