...
public interface AnnotationSet<ID extends Annotation, COLUMN extends Annotation> {
    ...
    /**
     * @return the Annoation class that marks a bean field as being persist-able.
     */
     ...
     * 
     * @param field the field from the bean
     * @param annotation the id annotation
     ...
     * be persisted, return <code>null</code>.
     *
     * @param field the field from the bean
